    ...
    <div style={{ background: "var(--bg-primary)", color: "var(--text-primary)" }}>
      ...
      <header className="relative overflow-hidden pt-36 pb-12 px-6" style={{ background: "var(--bg-primary)" }}>
        <div
          ...
          style={{ background: "radial-gradient(ellipse 90% 55% at 35% -15%, rgba(172,237,235,0.07) 0%, rgba(167,139,250,0.05) 45%, transparent 70%)" }}
        />
      ...
      <article className="px-6 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Problem + Stats */}
          <div className="p-6 rounded-2xl mb-12" style={{ background: "linear-gradient(135deg, rgba(172,237,235,0.06) 0%, rgba(167,139,250,0.06) 100%)", border: "1px solid rgba(172,237,235,0.15)" }}>
            ...
            {c.steps.items.map((step, i) => (
              <div key={i} className="p-6 rounded-2xl border" style={{ border: "1px solid var(--border-color)", background: "var(--bg-card)" }}>
                <div className="flex items-start gap-4">
                  <div className="text-2xl font-extrabold flex-shrink-0 w-10 leading-none mt-0.5" style={{ color: "#2C6B65", fontFamily: "var(--font-display)" }}>{step.number}</div>
                  <div className="flex-1">
                    ...
                    <span className="text-xs font-semibold px-3 py-1 rounded-full" style={{ background: "rgba(172,237,235,0.1)", color: "#2C6B65" }}>{step.tool}</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="p-5 rounded-xl flex items-start gap-4 mb-2" style={{ border: "1px solid var(--border-color)", background: "var(--bg-card)" }}>
            <div className="w-12 h-12 rounded-full flex items-center justify-center font-bold flex-shrink-0 text-white text-sm" style={{ background: "linear-gradient(135deg, #2C6B65 0%, #A78BFA 100%)" }}>
              {c.author.initials}
            </div>
            <div>
