...
const es: PageContent = {
  ...
  s4: {
    ...
    nuances: [
      "La tasa de conversión lead → reunión es 21.3% para SDRs humanos vs 8.2% para agentes de IA puro. Los agentes son mejores en volumen y velocidad; los humanos siguen ganando en conversión.",
    ...
    caseText: "$5M de pipeline generado, $2.4M cerrados en 8 meses con un agente SDR. ROI positivo y claro. Pero el equipo dedicó 15–20 horas semanales a supervisión, ajuste de prompts y revisión de calidad. Los mejores resultados vienen cuando alguien interno domina la herramienta.",
    highlight: "Los agentes son mejores que un SDR promedio. No superan a tus mejores performers. El modelo que gana es el híbrido: agente que genera volumen y contexto, humano que construye relación y cierra.",
  },
  s5: {
    ...
    agents: [
      ...
      },
      {
        ...
        solution: "Responde en menos de 60 segundos, cualifica con preguntas de contexto, agenda reunión y notifica al AE con briefing completo. Sin intervención humana hasta el momento de la llamada.",
      ...
      },
      {
        ...
        problem: "Antes de cada reunión, el AE invierte 20–30 minutos preparando contexto. Ese tiempo se multiplica por cada meeting del pipeline.",
        ...
        result: "+66% en win rate cuando el AE llega preparado con contexto real vs contexto genérico. Cero tiempo de preparación manual.",
      },
      {
        num: "04",
...
const en: PageContent = {
  ...
  s4: {
    ...
    nuances: [
      "Lead → meeting conversion rate is 21.3% for human SDRs vs 8.2% for pure AI agents. Agents win on volume and speed; humans still win on conversion.",
    ...
    caseText: "$5M in pipeline generated, $2.4M closed in 8 months with an AI SDR agent. Clear, positive ROI. But the team spent 15–20 hours per week on supervision, prompt tuning, and quality review. The best results come when someone internal masters the tool.",
    highlight: "Agents outperform the average SDR. They don't beat your best performers. The winning model is hybrid: agent generates volume and context, human builds relationship and closes.",
  },
  s5: {
    ...
    agents: [
      ...
      },
      {
        ...
        solution: "Responds in under 60 seconds, qualifies with context questions, books a meeting and notifies the AE with a full briefing. No human intervention until the call.",
      ...
      },
      {
        ...
        problem: "Before each meeting, the AE spends 20–30 minutes preparing context. That time multiplies across every pipeline meeting.",
        ...
        result: "+66% win rate when the AE arrives prepared with real context vs generic context. Zero manual prep time.",
      },
      {
        num: "04",
